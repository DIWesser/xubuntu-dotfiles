...
alias :q='exit'
# ls tweaks
alias la1='ls -A -1 | grep -v .DS_Store'
alias la='ls -A'

# Move back faster
alias ..="cd .."
# Clear shell window faster
alias clr="clear"

# Print weather to terminal
alias weather='wget -qO - http://wttr.in/ | head -7'

# Pull up school folder
alias school='cd ~/Dropbox/Education/E.\ 2017-2018\ Kings\ II && ranger'

# Go to CSCI Java Code folder
alias school-code='cd ~/Dropbox/Education/E.\ 2017-2018\ Kings\ II/CSCI\ 1100/Code && tmux'
